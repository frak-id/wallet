...
export function SignRequestModal({
     ...
     */
    const { message, address, rawMessage } = useMemo(() => {
    ...
    return (
        ...
        >
            ...
            >
                {/*TODO: Add request specific header, chain + relay protocol in the header?*/}
            </WcModalHeader>

            {/* TODO: Add stuff about the signature (payload) */}

            {/*Format this stuff, maybe small panel for each parts? */}
            <p className={styles.modalPairing__payload}>
                <strong>Message:</strong> {message}
                <br />
                <strong>From addr:</strong> {address}
            </p>
