...
- **`wallet-shared` scope rule**: STRICTLY wallet+listener. Not business/backend/shopify.
...
## Anti-Patterns
Importing `wallet-shared` from business/backend/shopify · wildcard exports · hardcoded chain IDs/addresses (use `app-essentials`) · creating new Vitest configs (extend `test-foundation/vitest.shared`).

## See Also
Parent `/AGENTS.md` · children `packages/{wallet-shared,design-system,app-essentials,test-foundation}/AGENTS.md` · `sdk/AGENTS.md`.
