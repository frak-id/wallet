...
- Updated dependencies [[`ddb7798`](https://github.com/frak-id/wallet/commit/ddb7798108c006bd7d5d655ab519b3f918c0c3b8), [`db0cca3`](https://github.com/frak-id/wallet/commit/db0cca3545d45518f3721416148f64ebc3f840e8)]:
  - @frak-labs/core-sdk@1.4.2

## 1.2.2

### Patch Changes

- [#310](https://github.com/frak-id/wallet/pull/310) [`90036f6`](https://github.com/frak-id/wallet/commit/90036f6a7e05fc3e0ada7703180d13e9aecf8d9e) Thanks [@srod](https://github.com/srod)! - Inject merchant component CSS on pages where no element carries a `placement`.
...
- [#234](https://github.com/frak-id/wallet/pull/234) [`9a1798c`](https://github.com/frak-id/wallet/commit/9a1798cfe397f0b6b4dc4049f5d8bab0587cc4d7) Thanks [@KONFeature](https://github.com/KONFeature)! - 🐛 fix: match UI-triggering query-param keys case-insensitively, so links whose case is mangled in transit (email tools / browsers that lowercase URLs) still work.
...
- Updated dependencies [[`9a1798c`](https://github.com/frak-id/wallet/commit/9a1798cfe397f0b6b4dc4049f5d8bab0587cc4d7)]:
...
- Updated dependencies [[`2a4c95e`](https://github.com/frak-id/wallet/commit/2a4c95ee770b4eb48cd04c4a434f817643cc8c7a)]:
...
- [#201](https://github.com/frak-id/wallet/pull/201) [`bc404c3`](https://github.com/frak-id/wallet/commit/bc404c34de4a12446874860c28bca2dc2392614b) Thanks [@KONFeature](https://github.com/KONFeature)! - 🩹 fix: `<frak-banner>` no longer auto-switches to its in-app browser redirect mode by default. A new opt-in prop `allowInappRedirect` (HTML attribute `allow-inapp-redirect="true"`) gates that behaviour, defaulting to `false`.
