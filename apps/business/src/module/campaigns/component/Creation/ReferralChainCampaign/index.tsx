...
function ChainArrow({ className }: { className?: string }) {
    return (
        ...
        >
            <path
                d="M2.89 5.33C4.36 5.33 5.55 4.14 5.55 2.67C5.55 1.19 4.36 -4.19e-05 2.89 -4.2e-05C1.41 -4.2e-05 0.22 1.19 0.22 2.67C0.22 4.14 1.41 5.33 2.89 5.33ZM2.89 38.67L5.77 33.67L-3.24e-05 33.67L2.89 38.67ZM2.89 2.67L2.39 2.67L2.39 34.17L2.89 34.17L3.39 34.17L3.39 2.67L2.89 2.67Z"
                fill="currentColor"
            />
        </svg>
    );
