    ...
    return (
        ...
        >
            <Controller
                ...
                name="rewardToken"
                render={({ field }) => {
                    // Drive mode only from token presence — never compare to the
                    // merchant default, or picking the default currency snaps the
                    // radio back to "use default" and blocks switching.
