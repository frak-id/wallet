...
/**
 * Get the reward history for a user (fallback to indexer if backend unavailable)
 * Primary implementation now uses backend API via useGetRewardHistory hook
 * @param account
 */
export async function getRewardHistory({
    ...
    try {
        ...
        // Fallback: return empty history if indexer unavailable
        return groupByDay([]);
    }
}
