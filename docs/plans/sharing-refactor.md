...
> **Partly superseded.** Everything about `cornerRadius` here — the param itself, its
> `clampedInt(0, 48)` codec, the `nativeOnly` gate that protected it, `useHostCornerRadius`, and
