...
judged on 2026-08-15** — both columns lead with their original values so other audit reports that
cite them still resolve, and carry any later re-grade after an arrow. Each finding cell ends with
the current read.
