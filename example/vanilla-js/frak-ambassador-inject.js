    ...
    const mount = (selector, replace = true) => {
       ...
       absorb that, so measure the pinned chrome and clear it. */
        ...
        window.__frakAmb = {
            ...
            image: (u) => {
                page.querySelector(".frak-art")?.classList.remove(
                    "frak-art-empty"
                );
                return set("image", `url("${u}")`);
            },
        };
