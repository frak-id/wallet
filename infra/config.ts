...
export const backendUrl = getStaticVariable({
    ...
    dev: isV2 ? "https://backend.v2.gcp-dev.frak.id" : "https://backend.gcp-dev.frak.id",
    local: "http://localhost:3030",
});
export const walletUrl = getStaticVariable({
    prod: "https://wallet.frak.id",
    dev: isV2 ? "https://wallet.v2.gcp-dev.frak.id" : "https://wallet-dev.frak.id",
    local: "https://localhost:3000",
});
export const businessUrl = getStaticVariable({
    prod: "https://business.frak.id",
    dev: isV2 ? "https://business.v2.gcp-dev.frak.id" : "https://business-dev.frak.id",
