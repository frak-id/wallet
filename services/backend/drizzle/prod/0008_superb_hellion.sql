...
CREATE TABLE "identity_nodes" (
	...
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "identity_nodes_unique_identity" UNIQUE NULLS NOT DISTINCT("identity_type","identity_value","merchant_id")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "merchant_webhooks_merchant_id_idx" ON "merchant_webhooks" USING btree ("merchant_id");--> statement-breakpoint
...
-- todo: This will fck up, need manual removal of the previous types.
