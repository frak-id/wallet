...
--> statement-breakpoint
DROP INDEX "interaction_logs_sharing_timestamp_idx";--> statement-breakpoint
...
CREATE INDEX "notification_sent_wallet_sent_at_idx" ON "notification_sent" USING btree ("wallet","sent_at");--> statement-breakpoint
CREATE INDEX "interaction_logs_sharing_timestamp_idx" ON "interaction_logs" USING btree (((payload->>'sharingTimestamp')::int)) WHERE "type" = 'create_referral_link';