...
CREATE INDEX "wallet_push_tokens_idx" ON "push_tokens" USING btree ("wallet");--> statement-breakpoint
...
CREATE UNIQUE INDEX "pairing_code_idx" ON "device_pairing" USING btree ("pairing_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "interaction_logs_external_event_unique_idx" ON "interaction_logs" USING btree ("merchant_id","type","external_event_id");