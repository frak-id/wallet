...
// (same approach as ReferralLinkRepository.test.ts). `mockTrxInsert` gets
// its table-dispatching implementation in beforeEach, where schema imports
// are available (vi.mock factories are hoisted above them).
//
